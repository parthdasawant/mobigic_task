...
import '../core/utils/group_shared.dart';
                  ...
                  Positioned.fill(
                      child: AnimatedBuilder(
                        ...
                        child: AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            num topLeftSquaredDis = pow(pressedX, 2) + pow(pressedY, 2);
                            num topRightSquaredDis = pow(constraints.maxWidth - pressedX, 2) + pow(pressedY, 2);
                            num botLeftSquaredDis = pow(pressedX, 2) + pow(constraints.maxHeight - pressedY, 2);
                            num botRightSquaredDis = pow(constraints.maxWidth - pressedX, 2) + pow(constraints.maxHeight - pressedY, 2);
                            num radius = sqrt(max(max(topLeftSquaredDis, topRightSquaredDis), max(botLeftSquaredDis, botRightSquaredDis)));
